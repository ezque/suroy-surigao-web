    ...
    <section class="featured-banner">
      <div class="banner-overlay">
        <div class="banner-content">
          ...
          <h2 class="banner-title">Siargao Island</h2>
          <p class="banner-subtext">
            Discover the surfing capital of the Philippines with pristine beaches and vibrant culture.
          </p>
    ...
    <section class="recommendations-section">
      <div class="section-header">
        ...
        <p class="section-desc">
          Based on your interests and previous visits
        </p>
      </div>
      <div class="recommendations-grid">
        <div class="recommendation-card">
          <div class="rec-image" style="background-image: url('/images/surfing.jpg')"></div>
          <div class="rec-content">
            <h3>Cloud 9 Surfing</h3>
            <p>Perfect waves for all skill levels</p>
            <div class="rec-meta">
              <span class="rec-distance">15km away</span>
              <span class="rec-rating">⭐ 4.7</span>
            </div>
          </div>
        </div>
        <div class="recommendation-card">
          <div class="rec-image" style="background-image: url('/images/sugba-lagoon.jpg')"></div>
          <div class="rec-content">
            <h3>Sugba Lagoon</h3>
            <p>Turquoise waters and diving platforms</p>
            <div class="rec-meta">
              <span class="rec-distance">22km away</span>
              <span class="rec-rating">⭐ 4.9</span>
            </div>
          </div>
        </div>
        <div class="recommendation-card">
          <div class="rec-image" style="background-image: url('/images/magpupungko.jpg')"></div>
          <div class="rec-content">
            <h3>Magpupungko Tidal Pools</h3>
            <p>Natural rock pools during low tide</p>
            <div class="rec-meta">
              <span class="rec-distance">18km away</span>
              <span class="rec-rating">⭐ 4.8</span>
            </div>
          </div>
        </div>
      </div>
